...
function alternate() {
    ...
    document.querySelector("#skill-container").innerHTML = '<div id="alternate-picking"><div class="top-table"> <div class="back-td"> <button onclick="back()" class="back-button"> < Back to menu</button> </div> <div class="title-td"> <h1 class="skill-title">Alternate Picking</h1> </div> <div class="timer-container"> <div class="timer"> <h3 class="minutes">10</h3> <h3>:</h3> <h3 class="seconds">00</h3> </div><button onclick="editTimer(1)" class="timer-edit"></button> </div> </div><div class="skill-options">            <button class="skill-option-buttons alternate-syn-button">SYN\'s Etude</button>            <button class="skill-option-buttons alternate-major-button">Major Scales</button>            <button class="skill-option-buttons alternate-minor-button">Minor Scales</button>            <button class="skill-option-buttons alternate-modes-button">Modes</button>            <div class="metronome">                <button class="metro-button">-</button>                <input type="number" class="bpm" name="bpm" value="100">                <button class="metro-button">+</button><br>                <button class="metro-play"></button>                <button class="metro-pause"></button>            </div>        </div>             <div class="skill-display"><div class="source"style="width: 100%;height: inherit;text-align: center"><h1>Choose A Source</div>            <div class="inner-display alternate-syn"><h1 class="syn-title">Alternate Picking I</h1><a target="_blank" href="https://syngates.com/lessons/alternate-picking-i.96/"><img class="tab-images" src="Design/syn/alternate1.png"></a><h1 class="syn-title">Alternate Picking II</h1><a target="_blank" href="https://syngates.com/lessons/alternate-picking-ii.97/"><img class="tab-images" src="Design/syn/alternate2.png"></a><h1 class="syn-title">Alternate Picking III</h1><a target="_blank" href="https://syngates.com/lessons/alternate-picking-iii.98/"><img class="tab-images" src="Design/syn/alternate3.png"></a><h1 class="syn-title">Alternate Picking IV</h1><a target="_blank" href="https://syngates.com/lessons/alternate-picking-iv.99/"><img class="tab-images" src="Design/syn/alternate4.png"></a><h1 class="syn-title">Alternate Picking V</h1><a target="_blank" href="https://syngates.com/lessons/alternate-picking-v.100/"><img class="tab-images" src="Design/syn/alternate5.png"></a><h1 class="syn-title">Alternate Picking VI</h1><a target="_blank" href="https://syngates.com/lessons/alternate-picking-vi.101/"><img class="tab-images" src="Design/syn/alternate6.png"></a><h1 class="syn-title">Alternate Picking VII</h1><a target="_blank" href="https://syngates.com/lessons/alternate-picking-vii.102/"><img class="tab-images" src="Design/syn/alternate7.png"></a><h1 class="syn-title">Alternate Picking VIII</h1><a target="_blank" href="https://syngates.com/lessons/alternate-picking-viii.103/"><img class="tab-images" src="Design/syn/alternate8.png"></a><h1 class="syn-title">Alternate Picking IX</h1><a target="_blank" href="https://syngates.com/lessons/alternate-picking-ix.104/"><img class="tab-images" src="Design/syn/alternate9.png"></a><h1 class="syn-title">Alternate Picking X</h1><a target="_blank" href="https://syngates.com/lessons/alternate-picking-x.105/"><img class="tab-images" src="Design/syn/alternate10.png"></a></div>            <div class="inner-display alternate-major">                <embed src="Design/scales/major-scale.pdf" width="100%" height="100%">            </div>             <div class="inner-display alternate-minor">                <embed src="Design/scales/minor-scale.pdf" width="100%" height="100%">            </div>            <div class="inner-display alternate-modes">                <img class="tab-images" src="Design/scales/modes1.png"><br>                <img class="tab-images" src="Design/scales/modes2.png">            </div>        </div>    </div>';
    minutes = "10";
...
function extras() {
    ...
    if (!extrasOn) {
        ...
        document.querySelector(".extra-button").style = "    margin-top: calc(1vw + 0.5vw); margin-bottom: calc(1vw - 0.5vw); box-shadow: 0 0 0; color: white; background-color: rgb(54, 54, 54)";
    } else {
        extrasOn = false;
...
function solos() {
    document.querySelector("#main-menu").style.display = "none";
    document.querySelector("#skill-container").innerHTML = '<div id="solos"> <div class="top-table"> <div class="back-td"> <button onclick="back()" class="back-button"> < Back to menu</button> </div> <div class="title-td"> <h1 class="skill-title">Solos</h1> </div> <div class="timer-container"> <div class="timer"> <h3 class="minutes">10</h3> <h3>:</h3> <h3 class="seconds">00</h3> </div><button onclick="editTimer(1)" class="timer-edit"></button> </div> </div> <div class="skill-options"> <button class="skill-option-buttons solos-exist-button" onclick="changeSolo(\'exist\')">EXIST</button> <button class="skill-option-buttons solos-exist-button" onclick="changeSolo(\'second-heartbeat\')">Second Heartbeat</button> <button class="skill-option-buttons solos-exist-button" onclick="changeSolo(\'paradigm\')">Paradigm</button> <button class="skill-option-buttons solos-exist-button" onclick="changeSolo(\'heretic\')">Heretic</button> <button class="skill-option-buttons solos-exist-button" onclick="changeSolo(\'the-stage\')">The Stage</button> <button class="skill-option-buttons solos-exist-button" onclick="changeSolo(\'crimson-day\')">Crimson Day</button> <button class="skill-option-buttons solos-exist-button" onclick="changeSolo(\'coming-home\')">Coming Home</button> <button class="skill-option-buttons solos-exist-button" onclick="changeSolo(\'nightmare\')">Nightmare</button> <button class="skill-option-buttons solos-exist-button" onclick="changeSolo(\'buried-alive\')">Buried Alive</button> <button class="skill-option-buttons solos-exist-button" onclick="changeSolo(\'natural-born-killer\')">Natural Born Killer</button> <button class="skill-option-buttons solos-exist-button" onclick="changeSolo(\'victim\')">Victim</button> <button class="skill-option-buttons solos-exist-button" onclick="changeSolo(\'dear-god\')">Dear God</button> <button class="skill-option-buttons solos-exist-button" onclick="changeSolo(\'seize-the-day\')">Seize The Day</button> <button class="skill-option-buttons solos-exist-button" onclick="changeSolo(\'sidewinder\')">Sidewinder</button> <button class="skill-option-buttons solos-exist-button" onclick="changeSolo(\'betrayed\')">Betrayed</button> <button class="skill-option-buttons solos-exist-button" onclick="changeSolo(\'m.i.a.\')">M.I.A.</button> <button class="skill-option-buttons solos-exist-button" onclick="changeSolo(\'not-invincible\')">Not Invincible</button> <button class="skill-option-buttons solos-exist-button" onclick="changeSolo(\'a-place-where-you-belong\')" style="font-size: 1.7vw;">A Place Where You Belong</button> <button class="skill-option-buttons solos-exist-button" onclick="changeSolo(\'the-last-fight\')">The Last Fight</button> <button class="skill-option-buttons solos-exist-button" onclick="changeSolo(\'waking-the-demon\')">Waking The Demon</button> <button class="skill-option-buttons solos-exist-button" onclick="changeSolo(\'say-goodnight\')">Say Goodnight</button> <button class="skill-option-buttons solos-exist-button" onclick="changeSolo(\'the-poison\')">The Poison</button> <button class="skill-option-buttons solos-exist-button" onclick="changeSolo(\'blackened\')">Blackened</button> <button class="skill-option-buttons solos-exist-button" onclick="changeSolo(\'nothin-else-matters\')" style="font-size: 1.7vw;">Nothing Else Matters</button> </div> <div class="skill-display"> <div class="source"style="width: 100%;height: inherit;text-align: center"> <h1 >Choose A Solo</h1> </div> <div class="inner-display solos-display"> <h1 class="solo-title" style="font-size: 4vw; margin: 0.5vw;"></h1> <div class="audio"> <audio controls class="solo-audio"> </audio> </div> <div class="solo-speed"> <button style="margin: 0;" class="metro-button" onclick="soloSpeedDown()">-</button> <input type="number" min="60" max="190" name="bpm" class="solo-bpm" oninput="changeRange(); changeSoloSpeed()"> <button style="margin: 0;" class="metro-button" onclick="soloSpeedUp()">+</button> <br><br> <input type="range" oninput="changeBpmNumber(); changeSoloSpeed()" name="bpm" min="60" max="190" value="190" class="solo-bpm-scrubber"> <br><label for="bpm">BPM</label> </div> <div class="tabs"> <h1 style="font-size: 4vw;">Tabs</h1> <button class="tabs-button" onclick="showTabs()">Tabs</button> <a target="_blank" href=""> <button class="tabs-button">SongSterr</button> </a> <br><br> <div class="guitar-1"></div> </div> </div> </div> </div>';
    updateListener();
