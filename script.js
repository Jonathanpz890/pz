...
function alternate() {
    ...
    document.querySelector("#skill-container").innerHTML = '<div id="alternate-picking"><div class="top-table"> <div class="back-td"> <button onclick="back()" class="back-button"> < Back to menu</button> </div> <div class="title-td"> <h1 class="skill-title">Alternate Picking</h1> </div> <div class="timer-container"> <div class="timer"> <h3 class="minutes">10</h3> <h3>:</h3> <h3 class="seconds">00</h3> </div><button onclick="editTimer(1)" class="timer-edit"></button> </div> </div><div class="skill-options">            <button class="skill-option-buttons alternate-syn-button">SYN\'s Etude</button>            <button class="skill-option-buttons alternate-major-button">Major Scales</button>            <button class="skill-option-buttons alternate-minor-button">Minor Scales</button>            <button class="skill-option-buttons alternate-modes-button">Modes</button>            <div class="metronome">                <button class="metro-button">-</button>                <input type="number" class="bpm" name="bpm" value="100">                <button class="metro-button">+</button><br>                <button class="metro-play"></button>                <button class="metro-pause"></button>            </div>        </div>             <div class="skill-display"><div class="source"style="width: 100%;height: inherit;text-align: center"><h1>Choose A Source</div>            <div class="inner-display alternate-syn"><h1 class="syn-title">Alternate Picking I</h1><a target="_blank" onclick="window.open(this.href, \'_blank\', \'toolbar=no, height=775, width=5000, top=1000\')" href="https://syngates.com/lessons/alternate-picking-i.96/"><img class="tab-images" src="Design/syn/alternate1.png"></a><h1 class="syn-title">Alternate Picking II</h1><a target="_blank" onclick="window.open(this.href, \'_blank\', \'toolbar=no, height=775, width=5000, top=1000\')" href="https://syngates.com/lessons/alternate-picking-ii.97/"><img class="tab-images" src="Design/syn/alternate2.png"></a><h1 class="syn-title">Alternate Picking III</h1><a target="_blank" onclick="window.open(this.href, \'_blank\', \'toolbar=no, height=775, width=5000, top=1000\')" href="https://syngates.com/lessons/alternate-picking-iii.98/"><img class="tab-images" src="Design/syn/alternate3.png"></a><h1 class="syn-title">Alternate Picking IV</h1><a target="_blank" onclick="window.open(this.href, \'_blank\', \'toolbar=no, height=775, width=5000, top=1000\')" href="https://syngates.com/lessons/alternate-picking-iv.99/"><img class="tab-images" src="Design/syn/alternate4.png"></a><h1 class="syn-title">Alternate Picking V</h1><a target="_blank" onclick="window.open(this.href, \'_blank\', \'toolbar=no, height=775, width=5000, top=1000\')" href="https://syngates.com/lessons/alternate-picking-v.100/"><img class="tab-images" src="Design/syn/alternate5.png"></a><h1 class="syn-title">Alternate Picking VI</h1><a target="_blank" onclick="window.open(this.href, \'_blank\', \'toolbar=no, height=775, width=5000, top=1000\')" href="https://syngates.com/lessons/alternate-picking-vi.101/"><img class="tab-images" src="Design/syn/alternate6.png"></a><h1 class="syn-title">Alternate Picking VII</h1><a target="_blank" onclick="window.open(this.href, \'_blank\', \'toolbar=no, height=775, width=5000, top=1000\')" href="https://syngates.com/lessons/alternate-picking-vii.102/"><img class="tab-images" src="Design/syn/alternate7.png"></a><h1 class="syn-title">Alternate Picking VIII</h1><a target="_blank" onclick="window.open(this.href, \'_blank\', \'toolbar=no, height=775, width=5000, top=1000\')" href="https://syngates.com/lessons/alternate-picking-viii.103/"><img class="tab-images" src="Design/syn/alternate8.png"></a><h1 class="syn-title">Alternate Picking IX</h1><a target="_blank" onclick="window.open(this.href, \'_blank\', \'toolbar=no, height=775, width=5000, top=1000\')" href="https://syngates.com/lessons/alternate-picking-ix.104/"><img class="tab-images" src="Design/syn/alternate9.png"></a><h1 class="syn-title">Alternate Picking X</h1><a target="_blank" onclick="window.open(this.href, \'_blank\', \'toolbar=no, height=775, width=5000, top=1000\')" href="https://syngates.com/lessons/alternate-picking-x.105/"><img class="tab-images" src="Design/syn/alternate10.png"></a></div>            <div class="inner-display alternate-major">                <embed src="Design/scales/major-scale.pdf" width="100%" height="100%">            </div>             <div class="inner-display alternate-minor">                <embed src="Design/scales/minor-scale.pdf" width="100%" height="100%">            </div>            <div class="inner-display alternate-modes">                <img class="tab-images" src="Design/scales/modes1.png"><br>                <img class="tab-images" src="Design/scales/modes2.png">            </div>        </div>    </div>';
    minutes = "10";
...
function sweep() {
    document.querySelector("#main-menu").style.display = "none";
    document.querySelector("#skill-container").innerHTML = '<div id="sweep-picking"><div class="top-table"> <div class="back-td"> <button onclick="back()" class="back-button">< Back to menu</button> </div> <div class="title-td"> <h1 class="skill-title">Sweep Picking</h1> </div> <div class="timer-container"> <div class="timer"> <h3 class="minutes">10</h3> <h3>:</h3> <h3 class="seconds">00</h3> </div><button onclick="editTimer(1)" class="timer-edit"></button> </div> </div><div class="skill-options"><button class="skill-option-buttons sweeping-syn-button">SYN\'s Etude</button><button class="skill-option-buttons sweeping-exist-button" onclick="changeRange()">EXIST</button>            <div class="metronome"><button class="metro-button">-</button><input type="number" class="bpm" name="bpm" value="100"><button class="metro-button">+</button><br><button class="metro-play"></button><button class="metro-pause"></button></div></div><div class="skill-display"><div class="source"style="width: 100%;height: inherit;text-align: center"><h1 >Choose A Source</div><div class="inner-display sweeping-syn"><h1 class="syn-title">Sweep Picking I</h1><a target="_blank" onclick="window.open(this.href, \'_blank\', \'toolbar=no, height=775, width=5000, top=1000\')" href="https://syngates.com/lessons/sweep-picking-i.126/"><img class="tab-images" src="Design/syn/sweeping1.png"></a><h1 class="syn-title">Sweep Picking II</h1><a target="_blank" onclick="window.open(this.href, \'_blank\', \'toolbar=no, height=775, width=5000, top=1000\')" href="https://syngates.com/lessons/sweep-picking-ii.127/"><img class="tab-images" src="Design/syn/sweeping2.png"></a><h1 class="syn-title">Sweep Picking III</h1><a target="_blank" onclick="window.open(this.href, \'_blank\', \'toolbar=no, height=775, width=5000, top=1000\')" href="https://syngates.com/lessons/sweep-picking-iii.128/"><img class="tab-images" src="Design/syn/sweeping3.png"></a><h1 class="syn-title">Sweep Picking IV</h1><a target="_blank" onclick="window.open(this.href, \'_blank\', \'toolbar=no, height=775, width=5000, top=1000\')" href="https://syngates.com/lessons/sweep-picking-iv.129/"><img class="tab-images" src="Design/syn/sweeping4.png"></a><h1 class="syn-title">Sweep Picking V</h1><a target="_blank" onclick="window.open(this.href, \'_blank\', \'toolbar=no, height=775, width=5000, top=1000\')" href="https://syngates.com/lessons/sweep-picking-v.130/"><img class="tab-images" src="Design/syn/sweeping5.png"></a><h1 class="syn-title">Sweep Picking VI</h1><a target="_blank" onclick="window.open(this.href, \'_blank\', \'toolbar=no, height=775, width=5000, top=1000\')" href="https://syngates.com/lessons/sweep-picking-vi.131/"><img class="tab-images" src="Design/syn/sweeping6.png"></a><h1 class="syn-title">Sweep Picking VII</h1><a target="_blank" onclick="window.open(this.href, \'_blank\', \'toolbar=no, height=775, width=5000, top=1000\')" href="https://syngates.com/lessons/sweep-picking-vii.132/"><img class="tab-images" src="Design/syn/sweeping7.png"></a><h1 class="syn-title">Sweep Picking VIII</h1><a target="_blank" onclick="window.open(this.href, \'_blank\', \'toolbar=no, height=775, width=5000, top=1000\')" href="https://syngates.com/lessons/sweep-picking-viii.133/"><img class="tab-images" src="Design/syn/sweeping8.png"></a><h1 class="syn-title">Sweep Picking IX</h1><a target="_blank" onclick="window.open(this.href, \'_blank\', \'toolbar=no, height=775, width=5000, top=1000\')" href="https://syngates.com/lessons/sweep-picking-ix.134/"><img class="tab-images" src="Design/syn/sweeping9.png"></a><h1 class="syn-title">Sweep Picking X</h1><a target="_blank" onclick="window.open(this.href, \'_blank\', \'toolbar=no, height=775, width=5000, top=1000\')" href="https://syngates.com/lessons/sweep-picking-x.135/"><img class="tab-images" src="Design/syn/sweeping10.png"></a></div><div class="inner-display sweeping-exist"><h1 style="font-size: 5vw; margin: 0.5vw;">EXIST</h1><audio controls class="solo-audio"<source src="Design/exist/exist.mp3" type="audio/mpeg"></audio><div class="solo-speed"><button style="margin: 0;" class="metro-button" onclick="soloSpeedDown()">-</button><input type="number" min="60" max="190" name="bpm" class="solo-bpm" oninput="changeRange(); changeSoloSpeed()"><button style="margin: 0;" class="metro-button" onclick="soloSpeedUp()">+</button><br><br><input type="range" oninput="changeBpmNumber(); changeSoloSpeed()" name="bpm" min="60" max="190" value="190" class="solo-bpm-scrubber"><br><label for="bpm">BPM</label></div><h1 style="font-size: 5vw;">Tabs</h1><button class="tabs-button sweeping-exist-tabs-one">Guitar 1</button><button class="tabs-button sweeping-exist-tabs-two">Guitar 2</button><a target="_blank" onclick="window.open(this.href, \'_blank\', \'toolbar=no, height=775, width=5000, top=1000\')" href="https://www.songsterr.com/a/wsa/avenged-sevenfold-exist-tab-s432185t5"><button class="tabs-button">SongSterr</button></a><br><br><div class="guitar-1"><img class="tab-images" src="Design/exist/exist1-1.png"><img class="tab-images" src="Design/exist/exist1-2.png"><img class="tab-images" src="Design/exist/exist1-3.png"><img class="tab-images" src="Design/exist/exist1-4.png"><img class="tab-images" src="Design/exist/exist1-5.png"><img class="tab-images" src="Design/exist/exist1-6.png"><img class="tab-images" src="Design/exist/exist1-7.png"><img class="tab-images" src="Design/exist/exist1-8.png"><img class="tab-images" src="Design/exist/exist1-9.png"></div><div class="guitar-2"><img class="tab-images" src="Design/exist/exist2-1.png"><img class="tab-images" src="Design/exist/exist2-2.png"><img class="tab-images" src="Design/exist/exist2-3.png"><img class="tab-images" src="Design/exist/exist2-4.png"><img class="tab-images" src="Design/exist/exist2-5.png"><img class="tab-images" src="Design/exist/exist2-6.png"><img class="tab-images" src="Design/exist/exist2-7.png"><img class="tab-images" src="Design/exist/exist2-8.png"></div></div></div></div>';
    minutes = "10";
...
function economy() {
    document.querySelector("#main-menu").style.display = "none";
    document.querySelector("#skill-container").innerHTML = '<div id="economy-picking"><div class="top-table"> <div class="back-td"> <button onclick="back()" class="back-button"> < Back to menu</button> </div> <div class="title-td"> <h1 class="skill-title">Economy Picking</h1> </div> <div class="timer-container"> <div class="timer"> <h3 class="minutes">10</h3> <h3>:</h3> <h3 class="seconds">00</h3> </div><button onclick="editTimer(1)" class="timer-edit"></button> </div> </div><div class="skill-options"><button class="skill-option-buttons economy-syn-button">SYN\'s Etude</button><button class="skill-option-buttons economy-major-button">Major Scales</button><button class="skill-option-buttons economy-minor-button">Minor Scales</button><button class="skill-option-buttons economy-modes-button">Modes</button>            <div class="metronome"><button class="metro-button">-</button><input type="number" class="bpm" name="bpm" value="100"><button class="metro-button">+</button><br><button class="metro-play"></button><button class="metro-pause"></button></div></div><div class="skill-display"><div class="source"style="width: 100%;height: inherit;text-align: center"><h1 >Choose A Source</div><div class="inner-display economy-syn">            <h1 class="syn-title">Economy Picking I</h1> <a target="_blank" onclick="window.open(this.href, \'_blank\', \'toolbar=no, height=775, width=5000, top=1000\')" href="https://syngates.com/lessons/economy-picking-i.106/"> <img class="tab-images" src="Design/syn/economy1.png"> </a> <h1 class="syn-title">Economy Picking II</h1> <a target="_blank" onclick="window.open(this.href, \'_blank\', \'toolbar=no, height=775, width=5000, top=1000\')" href="https://syngates.com/lessons/economy-picking-ii.107/"> <img class="tab-images" src="Design/syn/economy2.png"> </a> <h1 class="syn-title">Economy Picking III</h1> <a target="_blank" onclick="window.open(this.href, \'_blank\', \'toolbar=no, height=775, width=5000, top=1000\')" href="https://syngates.com/lessons/economy-picking-iii.108/"> <img class="tab-images" src="Design/syn/economy3.png"> </a> <h1 class="syn-title">Economy Picking IV</h1> <a target="_blank" onclick="window.open(this.href, \'_blank\', \'toolbar=no, height=775, width=5000, top=1000\')" href="https://syngates.com/lessons/economy-picking-iv.109/"> <img class="tab-images" src="Design/syn/economy4.png"> </a> <h1 class="syn-title">Economy Picking V</h1> <a target="_blank" onclick="window.open(this.href, \'_blank\', \'toolbar=no, height=775, width=5000, top=1000\')" href="https://syngates.com/lessons/economy-picking-v.110/"> <img class="tab-images" src="Design/syn/economy5.png"> </a> <h1 class="syn-title">Economy Picking VI</h1> <a target="_blank" onclick="window.open(this.href, \'_blank\', \'toolbar=no, height=775, width=5000, top=1000\')" href="https://syngates.com/lessons/economy-picking-vi.111/"> <img class="tab-images" src="Design/syn/economy6-1.png"><img class="tab-images" src="Design/syn/economy6-2.png"> </a> <h1 class="syn-title">Economy Picking VII</h1> <a target="_blank" onclick="window.open(this.href, \'_blank\', \'toolbar=no, height=775, width=5000, top=1000\')" href="https://syngates.com/lessons/economy-picking-vii.112/"> <img class="tab-images" src="Design/syn/economy7.png"> </a> <h1 class="syn-title">Economy Picking VIII</h1> <a target="_blank" onclick="window.open(this.href, \'_blank\', \'toolbar=no, height=775, width=5000, top=1000\')" href="https://syngates.com/lessons/economy-picking-viii.113/"> <img class="tab-images" src="Design/syn/economy8.png"> </a> <h1 class="syn-title">Economy Picking IX</h1> <a target="_blank" onclick="window.open(this.href, \'_blank\', \'toolbar=no, height=775, width=5000, top=1000\')" href="https://syngates.com/lessons/economy-picking-ix.114/"> <img class="tab-images" src="Design/syn/economy9.png"> </a> <h1 class="syn-title">Economy Picking X</h1> <a target="_blank" onclick="window.open(this.href, \'_blank\', \'toolbar=no, height=775, width=5000, top=1000\')" href="https://syngates.com/lessons/economy-picking-x.115/"> <img class="tab-images" src="Design/syn/economy10.png"> </a></div><div class="inner-display economy-major"><embed src="Design/scales/major-scale.pdf" width="100%" height="100%"></div><div class="inner-display economy-minor"><embed src="Design/scales/minor-scale.pdf" width="100%" height="100%"></div><div class="inner-display economy-modes"><img class="tab-images" src="Design/scales/modes1.png"><br><img class="tab-images" src="Design/scales/modes2.png"></div></div></dv>'
    updateListener();
...
function tapping() {
    document.querySelector("#main-menu").style.display = "none";
    document.querySelector("#skill-container").innerHTML = '<div id="tapping"><div class="top-table"> <div class="back-td"> <button onclick="back()" class="back-button"> < Back to menu</button> </div> <div class="title-td"> <h1 class="skill-title">Tapping</h1> </div> <div class="timer-container"> <div class="timer"> <h3 class="minutes">10</h3> <h3>:</h3> <h3 class="seconds">00</h3> </div><button onclick="editTimer(1)" class="timer-edit"></button> </div> </div><div class="skill-options"><button class="skill-option-buttons tapping-syn-button">SYN\'s Etude</button>            <div class="metronome"><button class="metro-button">-</button><input type="number" class="bpm" name="bpm" value="100"><button class="metro-button">+</button><br><button class="metro-play"></button><button class="metro-pause"></button></div></div><div class="skill-display"><div class="source"style="width: 100%;height: inherit;text-align: center"><h1 >Choose A Source</div><div class="inner-display tapping-syn">            <h1 class="syn-title">Tapping I</h1> <a target="_blank" onclick="window.open(this.href, \'_blank\', \'toolbar=no, height=775, width=5000, top=1000\')" href="https://syngates.com/lessons/tapping-i.136/"> <img class="tab-images" src="Design/syn/tapping1.png"> </a> <h1 class="syn-title">Tapping II</h1> <a target="_blank" onclick="window.open(this.href, \'_blank\', \'toolbar=no, height=775, width=5000, top=1000\')" href="https://syngates.com/lessons/tapping-ii.137/"> <img class="tab-images" src="Design/syn/tapping2-1.png"> </a> <a target="_blank" onclick="window.open(this.href, \'_blank\', \'toolbar=no, height=775, width=5000, top=1000\')" href="https://syngates.com/lessons/tapping-ii.137/"> <img class="tab-images" src="Design/syn/tapping2-2.png"> </a> <h1 class="syn-title">Tapping III</h1> <a target="_blank" onclick="window.open(this.href, \'_blank\', \'toolbar=no, height=775, width=5000, top=1000\')" href="https://syngates.com/lessons/tapping-iii.138/"> <img class="tab-images" src="Design/syn/tapping3-1.png"> </a> <a target="_blank" onclick="window.open(this.href, \'_blank\', \'toolbar=no, height=775, width=5000, top=1000\')" href="https://syngates.com/lessons/tapping-iii.138/"> <img class="tab-images" src="Design/syn/tapping3-2.png"> </a> <h1 class="syn-title">Tapping IV</h1> <a target="_blank" onclick="window.open(this.href, \'_blank\', \'toolbar=no, height=775, width=5000, top=1000\')" href="https://syngates.com/lessons/tapping-iv.139/"> <img class="tab-images" src="Design/syn/tapping4.png"> </a> <h1 class="syn-title">Tapping V</h1> <a target="_blank" onclick="window.open(this.href, \'_blank\', \'toolbar=no, height=775, width=5000, top=1000\')" href="https://syngates.com/lessons/tapping-v.140/"> <img class="tab-images" src="Design/syn/tapping5.png"> </a> <h1 class="syn-title">Tapping VI</h1> <a target="_blank" onclick="window.open(this.href, \'_blank\', \'toolbar=no, height=775, width=5000, top=1000\')" href="https://syngates.com/lessons/tapping-vi.141/"> <img class="tab-images" src="Design/syn/tapping6.png"> </a> <h1 class="syn-title">Tapping VII</h1> <a target="_blank" onclick="window.open(this.href, \'_blank\', \'toolbar=no, height=775, width=5000, top=1000\')" href="https://syngates.com/lessons/tapping-vii.142/"> <img class="tab-images" src="Design/syn/tapping7-1.png"> </a> <a target="_blank" onclick="window.open(this.href, \'_blank\', \'toolbar=no, height=775, width=5000, top=1000\')" href="https://syngates.com/lessons/tapping-vii.142/"> <img class="tab-images" src="Design/syn/tapping7-2.png"> </a> <h1 class="syn-title">Tapping VIII</h1> <a target="_blank" onclick="window.open(this.href, \'_blank\', \'toolbar=no, height=775, width=5000, top=1000\')" href="https://syngates.com/lessons/tapping-viii.143/"> <img class="tab-images" src="Design/syn/tapping8-1.png"> </a> <a target="_blank" onclick="window.open(this.href, \'_blank\', \'toolbar=no, height=775, width=5000, top=1000\')" href="https://syngates.com/lessons/tapping-viii.143/"> <img class="tab-images" src="Design/syn/tapping8-2.png"> </a> <a target="_blank" onclick="window.open(this.href, \'_blank\', \'toolbar=no, height=775, width=5000, top=1000\')" href="https://syngates.com/lessons/tapping-viii.143/"> <img class="tab-images" src="Design/syn/tapping8-3.png"> </a> <h1 class="syn-title">Tapping IX</h1> <a target="_blank" onclick="window.open(this.href, \'_blank\', \'toolbar=no, height=775, width=5000, top=1000\')" href="https://syngates.com/lessons/tapping-ix.144/"> <img class="tab-images" src="Design/syn/tapping9-1.png"> </a> <a target="_blank" onclick="window.open(this.href, \'_blank\', \'toolbar=no, height=775, width=5000, top=1000\')" href="https://syngates.com/lessons/tapping-ix.144/"> <img class="tab-images" src="Design/syn/tapping9-2.png"> </a> <a target="_blank" onclick="window.open(this.href, \'_blank\', \'toolbar=no, height=775, width=5000, top=1000\')" href="https://syngates.com/lessons/tapping-ix.144/"> <img class="tab-images" src="Design/syn/tapping9-3.png"> </a> <h1 class="syn-title">Tapping X</h1> <a target="_blank" onclick="window.open(this.href, \'_blank\', \'toolbar=no, height=775, width=5000, top=1000\')" href="https://syngates.com/lessons/tapping-x.145/"> <img class="tab-images" src="Design/syn/tapping10-1.png"> </a> <a target="_blank" onclick="window.open(this.href, \'_blank\', \'toolbar=no, height=775, width=5000, top=1000\')" href="https://syngates.com/lessons/tapping-x.145/"> <img class="tab-images" src="Design/syn/tapping10-2.png"> </a></div></div></div>';
    updateListener();
...
function legato() {
    document.querySelector("#main-menu").style.display = "none";
    document.querySelector("#skill-container").innerHTML = '<div id="legato-picking"><div class="top-table"> <div class="back-td"> <button onclick="back()" class="back-button"> < Back to menu</button> </div> <div class="title-td"> <h1 class="skill-title">Legato Picking</h1> </div> <div class="timer-container"> <div class="timer"> <h3 class="minutes">10</h3> <h3>:</h3> <h3 class="seconds">00</h3> </div><button onclick="editTimer(1)" class="timer-edit"></button> </div> </div><div class="skill-options"><button class="skill-option-buttons legato-syn-button">SYN\'s Etude</button><button class="skill-option-buttons legato-major-button">Major Scales</button><button class="skill-option-buttons legato-minor-button">Minor Scales</button><button class="skill-option-buttons legato-modes-button">Modes</button>            <div class="metronome"><button class="metro-button">-</button><input type="number" class="bpm" name="bpm" value="100"><button class="metro-button">+</button><br><button class="metro-play"></button><button class="metro-pause"></button></div></div><div class="skill-display"><div class="source"style="width: 100%;height: inherit;text-align: center"><h1 >Choose A Source</div><div class="inner-display legato-syn">            <h1 class="syn-title">Legato Picking I</h1> <a target="_blank" onclick="window.open(this.href, \'_blank\', \'toolbar=no, height=775, width=5000, top=1000\')" href="https://syngates.com/lessons/legato-i.116/"> <img class="tab-images" src="Design/syn/legato1.png"> </a> <h1 class="syn-title">Legato Picking II</h1> <a target="_blank" onclick="window.open(this.href, \'_blank\', \'toolbar=no, height=775, width=5000, top=1000\')" href="https://syngates.com/lessons/legato-ii.117/"> <img class="tab-images" src="Design/syn/legato2.png"> </a> <h1 class="syn-title">Legato Picking III</h1> <a target="_blank" onclick="window.open(this.href, \'_blank\', \'toolbar=no, height=775, width=5000, top=1000\')" href="https://syngates.com/lessons/legato-iii.118/"> <img class="tab-images" src="Design/syn/legato3.png"> </a> <h1 class="syn-title">Legato Picking IV</h1> <a target="_blank" onclick="window.open(this.href, \'_blank\', \'toolbar=no, height=775, width=5000, top=1000\')" href="https://syngates.com/lessons/legato-iv.119/"> <img class="tab-images" src="Design/syn/legato4.png"> </a> <h1 class="syn-title">Legato Picking V</h1> <a target="_blank" onclick="window.open(this.href, \'_blank\', \'toolbar=no, height=775, width=5000, top=1000\')" href="https://syngates.com/lessons/legato-v.120/"> <img class="tab-images" src="Design/syn/legato5.png"> </a> <h1 class="syn-title">Legato Picking VI</h1> <a target="_blank" onclick="window.open(this.href, \'_blank\', \'toolbar=no, height=775, width=5000, top=1000\')" href="https://syngates.com/lessons/legato-vi.121/"> <img class="tab-images" src="Design/syn/legato6.png"> </a> <h1 class="syn-title">Legato Picking VII</h1> <a target="_blank" onclick="window.open(this.href, \'_blank\', \'toolbar=no, height=775, width=5000, top=1000\')" href="https://syngates.com/lessons/legato-vii.122/"> <img class="tab-images" src="Design/syn/legato7.png"> </a> <h1 class="syn-title">Legato Picking VIII</h1> <a target="_blank" onclick="window.open(this.href, \'_blank\', \'toolbar=no, height=775, width=5000, top=1000\')" href="https://syngates.com/lessons/legato-viii.123/"> <img class="tab-images" src="Design/syn/legato8.png"> </a> <h1 class="syn-title">Legato Picking IX</h1> <a target="_blank" onclick="window.open(this.href, \'_blank\', \'toolbar=no, height=775, width=5000, top=1000\')" href="https://syngates.com/lessons/legato-ix.124/"> <img class="tab-images" src="Design/syn/legato9.png"> </a> <h1 class="syn-title">Legato Picking X</h1> <a target="_blank" onclick="window.open(this.href, \'_blank\', \'toolbar=no, height=775, width=5000, top=1000\')" href="https://syngates.com/lessons/legato-x.125/"> <img class="tab-images" src="Design/syn/legato10-1.png"> <img class="tab-images" src="Design//syn/legato10-2.png"></div><div class="inner-display legato-major"><embed src="Design/scales/major-scale.pdf" width="100%" height="100%"></div><div class="inner-display legato-minor"><embed src="Design/scales/minor-scale.pdf" width="100%" height="100%"></div><div class="inner-display legato-modes"><img class="tab-images" src="Design/scales/modes1.png"><br><img class="tab-images" src="Design/scales/modes2.png"></div></div></dv>'
    updateListener();
...
function pentatonics() {
    document.querySelector("#main-menu").style.display = "none";
    document.querySelector("#skill-container").innerHTML = '<div id="pentatonics"><div class="top-table"> <div class="back-td"> <button onclick="back()" class="back-button"> < Back to menu</button> </div> <div class="title-td"> <h1 class="skill-title">Pentatonic Scales</h1> </div> <div class="timer-container"> <div class="timer"> <h3 class="minutes">10</h3> <h3>:</h3> <h3 class="seconds">00</h3> </div><button onclick="editTimer(1)" class="timer-edit"></button></div> </div> </div<div><div class="skill-options"><button class="skill-option-buttons pentatonics-syn-button">SYN\'s Etude</button><button class="skill-option-buttons pentatonics-scales-button">Scales</button>            <div class="metronome"><button class="metro-button">-</button><input type="number" class="bpm" name="bpm" value="100"><button class="metro-button">+</button><br><button class="metro-play"></button><button class="metro-pause"></button></div></div><div class="skill-display"><div class="source"style="width: 100%;height: inherit;text-align: center"><h1 >Choose A Source</div><div class="inner-display pentatonics-syn"><h1 class="syn-title">Pentatonic I</h1> <a target="_blank" onclick="window.open(this.href, \'_blank\', \'toolbar=no, height=775, width=5000, top=1000\')" href="https://syngates.com/lessons/pentatonics-i.116/"> <img class="tab-images" src="Design/syn/pentatonics1.png"> </a> <h1 class="syn-title">Pentatonic II</h1> <a target="_blank" onclick="window.open(this.href, \'_blank\', \'toolbar=no, height=775, width=5000, top=1000\')" href="https://syngates.com/lessons/pentatonics-ii.117/"> <img class="tab-images" src="Design/syn/pentatonics2.png"> </a> <h1 class="syn-title">Pentatonic III</h1> <a target="_blank" onclick="window.open(this.href, \'_blank\', \'toolbar=no, height=775, width=5000, top=1000\')" href="https://syngates.com/lessons/pentatonics-iii.118/"> <img class="tab-images" src="Design/syn/pentatonics3.png"> </a> <h1 class="syn-title">Pentatonic IV</h1> <a target="_blank" onclick="window.open(this.href, \'_blank\', \'toolbar=no, height=775, width=5000, top=1000\')" href="https://syngates.com/lessons/pentatonics-iv.119/"> <img class="tab-images" src="Design/syn/pentatonics4.png"> </a> <h1 class="syn-title">Pentatonic V</h1> <a target="_blank" onclick="window.open(this.href, \'_blank\', \'toolbar=no, height=775, width=5000, top=1000\')" href="https://syngates.com/lessons/pentatonics-v.120/"> <img class="tab-images" src="Design/syn/pentatonics5.png"> </a> <h1 class="syn-title">Pentatonic VI</h1> <a target="_blank" onclick="window.open(this.href, \'_blank\', \'toolbar=no, height=775, width=5000, top=1000\')" href="https://syngates.com/lessons/pentatonics-vi.121/"> <img class="tab-images" src="Design/syn/pentatonics6-1.png"> <img class="tab-images" src="Design/syn/pentatonics6-2.png"> </a> <h1 class="syn-title">Pentatonic VII</h1> <a target="_blank" onclick="window.open(this.href, \'_blank\', \'toolbar=no, height=775, width=5000, top=1000\')" href="https://syngates.com/lessons/pentatonics-vii.122/"> <img class="tab-images" src="Design/syn/pentatonics7-1.png"> <img class="tab-images" src="Design/syn/pentatonics7-2.png"> </a> <h1 class="syn-title">Pentatonic VIII</h1> <a target="_blank" onclick="window.open(this.href, \'_blank\', \'toolbar=no, height=775, width=5000, top=1000\')" href="https://syngates.com/lessons/pentatonics-viii.123/"> <img class="tab-images" src="Design/syn/pentatonics8.png"> </a> <h1 class="syn-title">Pentatonic IX</h1> <a target="_blank" onclick="window.open(this.href, \'_blank\', \'toolbar=no, height=775, width=5000, top=1000\')" href="https://syngates.com/lessons/pentatonics-ix.124/"> <img class="tab-images" src="Design/syn/pentatonics9.png"> </a> <h1 class="syn-title">Pentatonic X</h1> <a target="_blank" onclick="window.open(this.href, \'_blank\', \'toolbar=no, height=775, width=5000, top=1000\')" href="https://syngates.com/lessons/pentatonics-x.125/"> <img class="tab-images" src="Design/syn/pentatonics10.png"></div><div class="inner-display pentatonics-scales"><img class="tab-images" src="Design/scales/pentatonic-scales.jpg"></div></div></div>';
    updateListener();
